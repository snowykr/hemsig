...
def _print_curator_first_run_notice() -> None:
    ...
    print("  Help:         hermes curator --help")
...
def _load_installable_optional_extras() -> list[str]:
    ...
    # Entries look like "hermes-agent[slack]" or "package-name[extra]".
...
def main():
    ...
    gateway_parser = subparsers.add_parser(
        ...
        description="Manage the messaging gateway (Telegram, Discord, Slack, Signal, Email, Home Assistant, Webhooks, API Server)",
    )
...
""",
    ...
    pairing_approve_parser.add_argument(
        "platform", help="Platform name (telegram, discord, slack, signal, email)"
    )
    ...
    def cmd_sessions(args):
        ...
        if action == "list":
            ...
            for src in ["cli", "telegram", "discord", "slack", "signal", "email"]:
