...
_CRON_AUTO_DELIVER_TARGETS: ContextVar[object] = ContextVar("HERMES_CRON_AUTO_DELIVER_TARGETS", default=_UNSET)
...
_VAR_MAP: dict[str, ContextVar[object]] = {
    ...
    "HERMES_CRON_AUTO_DELIVER_TARGETS": _CRON_AUTO_DELIVER_TARGETS,
}
